!(function (e) {
  ...
  function (e, t, n) {
    ...
    function u(e) {
      ...
      else for (var n = 0; n < e; ++n) t[n] = Math.floor(256 * Math.random());
    ...
    var w = function (e) {
        ...
        (e._sx = void 0 !== i ? i : 0),
          ...
          void 0 !== document.location &&
            (e._dl = document.location.toString()),
      ...
      y = function (e) {
        var t,
          n = O();
        for (t = 0; t < n.length; ++t) if (e == n[t]) return;
        n.push(e), h(n);
      },
      h = function (e) {
        ...
        identifyAnonUser: function (e) {
          if ((k(!1), c != e))
            if ("anon" === a || null === a) {
              ...
              x("ai", e), (c = e), (a = "anon");
            } else w({ _en: "_aliasUser", anonId: e });
        },
    ...
    function T() {
      return (
        ...
        window._tkq.a || (j(), (window._tkq = new b(window._tkq))),
        I
      );
    }
  },
  ...
  function (e, t, n) {
    ...
    var l = function (e) {
        return (
          0 ===
          e.indexOf("".concat(location.protocol, "//").concat(location.host))
        );
      },
      s = n(2);
    function p(e, t) {
        ...
        ((d = (function (e) {
          var t = {
            update: function () {
              ...
              return (
                !l(n) &&
                (t.getOriginal() || (r = e.set("or", n, 5 * o)),
    ...
    Array.isArray(window._wca) &&
      window._wca.forEach(function (e) {
        m.push(e);
      }),
      (window._wca = m);
  },
